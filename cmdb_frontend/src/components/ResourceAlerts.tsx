...
interface ResourceAlertsProps {
  ...
  pagination?: boolean; // Adjust pagination type for antd 3.x
}

const ResourceAlerts: React.FC<ResourceAlertsProps> = ({ data, lowThreshold, highThreshold, triggerUpdate, pagination = true }) => {
  ...
  }, [data, lowThreshold, highThreshold]); // Removed triggerUpdate from dependencies
